		...
		<?php if(in_array($emplacement,$lieux)): ?>
			...
			<details>
				<summary class="Eye-Tree-titre1">Personnes ayant données à <?php echo ''.$emplacement.''; ?>: </summary><p>
					...
					{
						echo '<details>
					<summary class="Eye-Tree-titre2"><a class="restitutionDon-a" href="donPerDonnateur.php?id=' . $idAuteurs[$i] . '">' . $nomAuteurs[$i] . ' :  ' . $fonctionAuteurs[$i] . '</a> ( ' . $nb_don_auteurs[$i] . ' )</summary><div class="Eye-Tree-content" ><p>';
			...
			<details>
				<summary class="Eye-Tree-titre1">Personnes ayant recues des dons à <?php echo ''.$emplacement.''; ?>: </summary><p>
					...
					{
						echo '<details><summary class="Eye-Tree-titre2"><a class="restitutionDon-a" href="donPerDonnateur.php?id=' . $idBeneficiaires[$i] . '">' . $nomBeneficiaires[$i] . ' :  ' . $fonctionBeneficiaires[$i] . '</a> ( ' . $nb_don_beneficiaires[$i] . ' )</summary><div class="Eye-Tree-content" ><p>';
						//Requête pour avoir les dons par donneurs:
