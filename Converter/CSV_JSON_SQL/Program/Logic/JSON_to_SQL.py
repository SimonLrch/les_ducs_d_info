    ...
    def DonInter(self):
        ...
        for don in self.json_file:
            for item in self.json_file[don]:
                ...
                query = 'SELECT COUNT(*) as Res FROM don WHERE forme = "' + str(item['Formes']) \
                ...
                if item['Intermediaire'] != "":
                    req_intermediaire = 'SELECT idPersonne FROM personne WHERE nom = "' + str(
                        item['Intermediaire']) + '"'
                    ...
                    req_inter = 'INSERT IGNORE INTO intermediaire(idDon,idIntermediaire) VALUES ("' + str(
                        id_don) + '", "' \
                                + str(intermediaire) + '")'
